...
from dot.models.properties import CHECKPOINT_ROOT, CONFIG_ROOT
...
class BaseOptions:
    def initialize(self, parser):
        ...
        parser.add_argument("--estimator_config", type=str, default=CONFIG_ROOT / "raft_patch_8.json")
        parser.add_argument("--estimator_path", type=str, default=CHECKPOINT_ROOT / "cvo_raft_patch_8.pth")
        parser.add_argument("--flow_mode", type=str, default="direct", choices=["direct", "chain", "warm_start"])

        # Optical flow refiner
        parser.add_argument("--refiner_config", type=str, default=CONFIG_ROOT / "raft_patch_4_alpha.json")
        parser.add_argument("--refiner_path", type=str, default=CHECKPOINT_ROOT / "movi_f_raft_patch_4_alpha.pth")

        # Point tracker
        parser.add_argument("--tracker_config", type=str, default=CONFIG_ROOT / "cotracker2_patch_4_wind_8.json")
        parser.add_argument("--tracker_path", type=str, default=CHECKPOINT_ROOT / "movi_f_cotracker2_patch_4_wind_8.pth")
